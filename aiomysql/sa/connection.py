...
class SAConnection:
    ...
    def _execute(self, query, *multiparams, **params):
        ...
        if isinstance(query, str):
            ...
            compiled = query.compile(dialect=self._dialect,
                                     schema_translate_map=self._execution_options['schema_translate_map'] if 'schema_translate_map' in self._execution_options else None)
    ...
    def execution_options(self, **opts):
        self._execution_options.update(opts)
        return self
